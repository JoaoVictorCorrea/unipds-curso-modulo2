...
@RestController
@RequestMapping("/travel/easy-rag")
public class EasyRagTravelController {

    private final EasyRagAssistant assistant;
    private final EmbeddingStore<TextSegment> embeddingStore;
    private final EmbeddingModel embeddingModel;

    public EasyRagTravelController(EasyRagAssistant assistant,
                                   @Qualifier("easyRagEmbeddingStore") EmbeddingStore<TextSegment> embeddingStore,
